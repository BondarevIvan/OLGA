...
class CannyEdgeDetector : public EdgeDetector
{
    public:
        ...
        void detect_edges(bool serial, int num_threads);

    private:
        /* CPU implementation */
        void apply_gaussian_filter(pixel_t *blurred_pixels, pixel_t *input_pixels, double kernel[KERNEL_SIZE][KERNEL_SIZE], int num_threads);
